...
@include('datoslegajo.modals.modalLicencias')
...
<script>
    ...
    document.getElementById('formAdd').addEventListener('submit', function(e) {
        e.preventDefault(); 
        onClickSaveAdd("licencias_crud","licencias_crud")
    });
    
    document.getElementById('formEdit').addEventListener('submit', function(e) {
        e.preventDefault();
        //OCULTAR TABLA DE VLP AL EDITAR
        onClickSaveEdit("licencias_crud", "licencias_crud");
    });

    function btn_editCRUD(data) {
        editCRUD(data, "licencias_crud", "Licencias");
            ...
            { 
                title: "ACCIONES",  data: 'id', name: 'id', orderable: false, render: function(data, type) {
                    ...
                    <div class="d-flex flex-row">
                        <button onclick='viewCRUD(${data},"licencias_crud","Licencias")' id="btnVer" class="btn btn-info mr-2">
                            <i class="fas fa-eye" id="editIcon"></i>
                        </button>
                        @hasanyrole('ADMIN|COORDINADOR')
                        <button onclick='deleteCRUD(${data},"licencias_crud","licencias_crud")' class='btn btn-danger btn-sm mr-2' title='Eliminar'>
