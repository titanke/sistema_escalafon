    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">SANCIÓN</h5>
            ...
            <div class="modal-body">
                <form id="formEdit" class="d-flex flex-column"  enctype="multipart/form-data">
                    ...
                    <div class="form-row gap-3 ">
                        ...
                        <div class="form-floating">
                            <input type="date" class="form-control" id="Eddesde" name="desde" >
                            <label for="entidad">Desde</label>
                        </div>

                        <div class="form-floating">
                            <input type="date" class="form-control" id="Edhasta" name="hasta" >
                            <label for="entidad">Hasta</label>
                        </div>

                        <x-select-tipo-doc id="Edidtd" name="idtd" :tdoc="$tdoc" categoria="SAN" label="Tipo Documento"/>
