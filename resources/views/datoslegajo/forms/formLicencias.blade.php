...
<form id="formAdd"class="d-flex flex-column"  enctype="multipart/form-data" >
    ...
    <div class="form-row gap-3">
        ...
        <div class="form-floating">
            <textarea id="Edescripcion" class="form-control" name="descripcion" 
            style="text-align: left; direction: ltr;"></textarea>
            <label >Motivo</label>
        </div>
        <x-select-tipo-doc id="Eidtd" name="idtd" :tdoc="$tdoc" categoria="LIC" label="Tipo Documento"/>
        <div class="form-floating">
        ...
        <div id="acuenta" class="form-floating">
            <select class="form-select" id="Eacuentavac" name="acuentavac" onchange="CambioPeriodo(this)">
        ...
        <div class="form-floating" id="cong">                        
            <select class="form-select" id="Econgoce" name="congoce">
                <option hidden selected></option>
                <option value="NO"selected>NO</option>
                <option value="SI">SI</option>
            </select>     
        ...
        <div class="form-floating acuenta_vac_cont">
            <input type="number" class="form-control" id="Eperiodo" name="periodo" placeholder="periodo" onchange="validar_vlp(validacion)" >
