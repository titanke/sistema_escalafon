...
<form id="formAdd" class="d-flex flex-column"  enctype="multipart/form-data" >
    ...
    <div class="form-row gap-3 ">
        <div class="form-floating">
            <input type="text" class="form-control" id="Edescripcion" name="descripcion" placeholder="Ejm. FELICITACIONES, CONDECORACIONES" required>
            <label for="entidad"class="required">Descripción<span class="required">*</span></label>
        </div>

        <x-select-tipo-doc id="Eidtd" name="idtd" :tdoc="$tdoc" categoria="REC" label="Tipo Documento"/>
        <div class="form-floating">
