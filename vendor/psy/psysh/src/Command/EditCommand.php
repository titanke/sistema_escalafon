...
class conpensaciones_crudmand extends Command implements ContextAware
{
    /**
     * @var string
     */
    ...
    protected function configure()
    {
        $this
            ->setName('edit')
            ->setDefinition([
                new InputArgument('file', InputArgument::OPTIONAL, 'The file to open for editing. If this is not given, sanciones_crud a temporary file.', null),
                new InputOption(
                    'exec',
                    'e',
